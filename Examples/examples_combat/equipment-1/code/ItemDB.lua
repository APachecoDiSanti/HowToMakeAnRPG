ItemDB =
{
    ...
    },
    {
        ...
        icon = "robe",
        restriction = {"mage"},
        description = "A cloak of dragon sacales.",
        stats = {add={defense=3, resist=10}}
    },
    {
        name = "Singer's Stone",
        type = "accessory",
    ...
    },
    {
        ...
        use = {action="small_heal", target="any", target_default="friendly_wounded", hint="Choose target to heal"}
    },
    {
        name = "Life Salve",
        type = "useable",
        description = "Restore a character from the brink of death.",
        use = {action="revive", target="any", target_default="friendly_dead", hint="Choose target to revive"}
    }
}
