function CreateWorldMap()
  local encountersWorld = {
    ...
    {
      { oddment = 95, item = {}},
      { oddment = 5, item = { background = "combat_bg_field.png", enemy = {"goblin_field", "goblin_field", "goblin_field"}}},
    },
    -- 2. blue: forest
    {
      { oddment = 90, item = {}},
      { oddment = 10, item = { background = "combat_bg_field.png", enemy = {"goblin_forest", "goblin_forest", "goblin_forest"}}},
    },
    -- 2. pink: forest pass
    {
      { oddment = 85, item = {}},
      { oddment = 6, item = { background = "combat_bg_field.png", enemy = {"goblin_field", "goblin_forest", "goblin_field"}}},
      { oddment = 6, item = { background = "combat_bg_forest.png", enemy = {"goblin_forest", "goblin_field", "goblin_forest"}}},
    },
  }
