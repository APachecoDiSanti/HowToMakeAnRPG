...
-- The town map gets the id "handin"
...
local intro = {
    ...
    SOP.FadeOutScreen(),
    SOP.MoveNPC("major", "handin", {"right", "right", "left", "left", "down"}),
    ...
    -- Party members cna walk into the hero and return control to the player
    SOP.NoBlock(SOP.MoveNPC("thief", "handin",  {"right", "up"})),
    SOP.FadeOutChar("handin", "thief"),
    SOP.RunAction("RemoveNPC", {"handin", "thief"}, {GetMapRef}),
    SOP.NoBlock(SOP.MoveNPC("mage", "handin",  {"left", "up", "up"})),
