...
function Textbox:Create(params)
  ...
  -- Calculate center point from mSize, use this to scale
...
function Textbox:Render(renderer)
  ...
  self.mPanel:CenterPosition(self.mX, self.mY, self.mWidth * scale, self.mHeight * scale)
  ...
  renderer:DrawText2d(textLeft, textTop, self.mText, Vector.Create(1, 1, 1, 1))
end
