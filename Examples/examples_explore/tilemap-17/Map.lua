...
-- Map constructor, mapDef is a Tiled definition
function Map:Create(mapDef)
  ...
  this.mUVs = GenerateUVs(this.mTileWidth, this.mTileHeight, this.mTextureAtlas)
...
function Map:Render(renderer)
  -- Get the top left and bottom right pixel of the camera and use to get the tile
