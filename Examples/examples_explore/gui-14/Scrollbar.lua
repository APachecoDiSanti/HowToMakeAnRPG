...
function Scrollbar:Create(texture, height)
  ...
  local textHeight = texture:GetHeight()
  ...
  -- The texture should include 4 equally sized pieces that make a scrollbar
  this.mTileHeight = textHeight / 4
  ...
  -- Height should ignore the up and down arrows
...
function Scrollbar:SetNormalValue(v)
  ...
  -- Subtracting caret, to take into account the first -haldcaret and the one at the other end
