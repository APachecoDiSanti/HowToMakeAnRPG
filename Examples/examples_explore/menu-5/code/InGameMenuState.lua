...
function InGameMenuState:Create(stack)
    local this = { mStack = stack}
    this.mStateMachine = StateMachine:Create {
        ["frontmenu"] = function() return FrontMenuState:Create(this) end,
        ["items"] = function() return this.mStateMachine.mEmpty end,
        ["magic"] = function() return this.mStateMachine.mEmpty end,
        ["equip"] = function() return this.mStateMachine.mEmpty end,
        ["status"] = function() return this.mStateMachine.mEmpty end,
    }
